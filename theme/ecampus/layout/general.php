     ...
     <div class="row">
        <div class="span4">
            <section class="homepage-block sticky">
                <div class="image"><img src="/theme/ecampus/img/module/homepage-block/home-block-1.png" width="351" height="161" alt="Post-doctoral Certificates" /></div>
        ...
        <div class="span4">
            <section class="homepage-block sticky">
                <div class="image"><img src="/theme/ecampus/img/module/homepage-block/home-block-2.png" width="351" height="161" alt="Continuing Education" /></div>
        ...
        <div class="span4">
            <section class="homepage-block sticky">
                <div class="image"><img src="/theme/ecampus/img/module/homepage-block/home-block-3.png" width="351" height="161" alt="ePortfolios" /></div>
...
<div style="display: none"><?php echo $OUTPUT->main_content() ?></div>
    ...
    <?php if ($hasfooter) { ?>
        ...
        <link rel="stylesheet" type="text/css" href="/theme/ecampus/javascript/fancybox/jquery.fancybox-1.3.4.css"/>
        <script src="/theme/ecampus/javascript/fancybox/jquery.fancybox-1.3.4.pack.js"></script>
    <?php
} ?>
